 ...
 * Messages Model
 *
 * @property \Cake\ORM\Association\BelongsTo $MailboxSends
 * @property \Cake\ORM\Association\HasMany $MailboxSends
 *
...
class MessagesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('MailboxSends', [
            'foreignKey' => 'mailbox_send_id',
            'joinType' => 'INNER'
        ]);
        $this->hasMany('MailboxSends', [
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('numer_client')
            ->requirePresence('numer_client', 'create')
            ->notEmpty('numer_client');
    ...
    {
        $rules->add($rules->existsIn(['mailbox_send_id'], 'MailboxSends'));
